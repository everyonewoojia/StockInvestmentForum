...
| 成员姓名 | 角色/职能 | 负责模块 |
| :--- | :--- | :--- |
| 张袖 | 项目经理 (PM) | 项目进度管理、需求定义、整体合规流程规划 |
| 邢钦典 | 后端架构师 | 数据库设计、系统核心架构、API接口规范 |
| 余世泽 | 前端开发负责人 | 移动端UI/UX设计、前端组件库开发 |
| 张天润 | 前端开发工程师 | 用户系统（登录/资料）、个人中心交互实现 |
| 伍宏杰 | 后端开发工程师 | 用户认证、账户系统、私信系统 |
| 黄嘉儿 | 后端开发工程师 | 内容发布系统、多级评论、附件管理 |
| 姬卓希 | 数据与算法工程师 | 搜索服务、个性化推荐算法、数据分析报表 |
| 张怀月 | 测试/运维工程师 | 自动化审核规则、合规性监控、系统部署与CI/CD |
